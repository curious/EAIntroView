...
- (UIView *)viewForPage:(EAIntroPage *)page atXIndex:(CGFloat)xIndex {
    ...
    if(page.titleIconView) {
        ...
        CGRect oldFrame = page.titleIconView.frame;
        page.titleIconView.frame = CGRectMake(oldFrame.origin.y, oldFrame.origin.x + 20, oldFrame.size.width - 40, oldFrame.size.height - 40);
    ...
    if(page.title.length) {
        ...
        [pageView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-titleMargin-[titleLabel]-titleMargin-|" options:NSLayoutFormatAlignAllTop metrics:@{@"titleMargin" : @(page.titleSideMargin)} views:@{@"titleLabel" : titleLabel}]];
    }
